...
"""Configuration for CSM-1B in the vLLM-Omni single-stage pipeline.
...
class CsmConfig(PretrainedConfig):
    ...
    def __init__(self, **kwargs):
        ...
        self.max_position_embeddings = backbone_cfg.get(
            "max_position_embeddings", _BACKBONE_MAX_POSITION_EMBEDDINGS
        )
        ...
        self.codec_pretrained_name_or_path = getattr(
            self, "codec_pretrained_name_or_path", "kyutai/mimi"
        )
